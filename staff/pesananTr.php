    ...
    <div class="flex items-center bg-white p-6 border-b border-gray-200 px-14">
      ...
      <div>
        <div class="flex justify-around w-[30%] mb-5 mx-auto">
          <button class="pesanBrBtn p-2 px-3 font-semibold rounded-full text-black hover:bg-slate-500 hover:shadow-lg" onclick="window.location='pesananBr.php'">pesanan baru</button>
          <button class="pesanTrBtn p-2 px-3 font-semibold rounded-full bg-black text-white hover:shadow-lg" onclick="window.location='pesananTr.php'" >pesanan yang diterima</button>
        </div>
